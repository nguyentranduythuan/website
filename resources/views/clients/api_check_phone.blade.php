...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="#">Quản lý API Check Phone</a>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
                    ...
                    <div class="portlet light">
                        ...
                        <div class="portlet-body">
                            <div class="tab-content">
                                <form class="form-without-legend" role="form" id="form-import-sms" method="post" action="{{ url('/client/api_phone/create_api') }}">
                                    {!! csrf_field() !!}
                        ...
                        <div class="portlet-title tabbable-line">
                            ...
                            <div class="actions">
                                <div class="btn-group btn-group-devided" data-toggle="buttons">
                                    <a href="{{ URL::asset('demo/huong-dan-dau-noi-api-check-phone-wemarketing.pdf') }}" target="_blank" class="btn btn-transparent grey-salsa btn-circle btn-sm active">Hướng dẫn đấu nối API</a>
                                </div>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="tab-content">
                                <div class="table-container">
                                    <table class="table table-striped table-bordered table-hover" id="datatable_table_list" data-sort="1" data-order="desc" data-link_ajax="{{ url('/client/api_phone/ajax') }}">
                                    <thead>
...
<script type="text/javascript">
    ...
    function updateStatusAPI(id, status)
    {
        ...
        $.ajax({
            url: "{{ url('/client/api_phone/update-status') }}", 
            type : "POST", 
            dataType : 'json',
            data: formData,
            async: true,
