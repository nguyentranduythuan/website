                    ...
                    <div class="portlet light">
                        <div class="portlet-title tabbable-line">
                            ...
                            <ul class="nav nav-tabs">
                                <li>
                                    <a href="{{ url('/client/payment') }}">Lịch sử nạp tiền</a>
                                </li>
                                <li class="active">
                                    <a href="#tab_1_2">Lịch sử sử dụng</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="tab-pane active" id="tab_1_2">
                                    <div class="tab-content">
                                        <div class="table-container">
                                            <table class="table table-striped table-bordered table-hover" id="datatable_table_list" data-sort="1" data-order="desc" data-link_ajax="{{ url('/client/payment/ajax_history') }}">
                                            <thead>
