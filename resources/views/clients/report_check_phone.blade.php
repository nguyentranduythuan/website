...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="#">Danh sách Số điện thoại cần kiểm tra</a>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>Danh sách Số điện thoại cần kiểm tra
                </div>
                <div class="actions">
                    <div class="btn-group">
            ...
            <div class="portlet-body">
                <div class="table-container">
                    <table class="table table-striped table-bordered table-hover" id="datatable_table_list" data-sort="1" data-order="desc" data-link_ajax="{{ url('/client/report_phone/ajax') }}">
                        <thead>
...
<script type="text/javascript">
    ...
    function onExport(e)
    {
        ...
        $.ajax({
            url: "{{ url('/client/report_phone/download') }}", 
            type : "POST", 
            dataType : 'json',
            data: formData,
            async: true,
            ...
            success : function(result) {
                ...
                if(result.status)
                {
                    ...
                    link.download="report_phone.xlsx";
                    link.click();
                }
                else
                {
