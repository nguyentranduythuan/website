...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="#">Nhập data cho tool kiểm tra số điện thoại</a>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
            ...
            <div class="portlet light profile-sidebar-portlet">
                <div class="portlet-title tabbable-line">
                    <div class="caption caption-md">
                        ...
                        <span class="caption-subject font-blue-madison bold uppercase">Nhập data cho tool kiểm tra số điện thoại</span>
                    </div>
                </div>
                <div class="portlet-body">
                    <form class="form-without-legend" role="form" id="form-import-sms" method="post" action="{{ url('/client/import_phone/import_data') }}">
                        {!! csrf_field() !!}
                        <div class="form-group">
                            <label class="control-label">Hãy chọn chiến dịch bạn muốn chạy</label>
                        ...
                        <div class="form-group">
                            <label class="control-label">Chọn file excel bạn muốn kiểm tra.</label>
                            ...
                            <label class="control-label">Dung lượng file dưới 2Mb. Bạn có thể download file mẫu <a href="{{ URL::asset('demo/data_phone.xlsx') }}" target="_blank">tại đây</a></label>
                        </div>
                        @if($campaign_selected)
                        <div class="form-group">
                            <label class="control-label">Giá Kiểm tra số thành công</label>
                            <input type="text" placeholder="Giá Kiểm tra" readonly="" name="price_call" value="{{ formatCurrency($campaign_selected->price_call) }}" class="form-control"/>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Giá Kiểm tra số không thành công</label>
                            <input type="text" placeholder="Giá Kiểm tra" readonly="" name="price_call_no" value="{{ formatCurrency(20) }}" class="form-control"/>
                        </div>
                        @endif
                ...
                <div class="col-md-12">
                    <div class="portlet light">
                        <div class="portlet-title tabbable-line">
                            <div class="caption caption-md">
                                <i class="icon-globe theme-font hide"></i>
                                <span class="caption-subject font-blue-madison bold uppercase">Danh sách kiểm tra cho chiến dịch này</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="tab-content">
                                ...
                                <div class="table-container">
                                    <table class="table table-striped table-bordered table-hover" id="datatable_table_list" data-sort="1" data-order="desc" data-link_ajax="{{ url('/client/import_phone/ajax?campaign_id=').$campaign_selected->id }}">
                                    <thead>
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <td>
                                                <div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
                                                    <input type="text" class="form-control form-filter input-sm" readonly name="time_call_from" placeholder="From">
                                                    <span class="input-group-btn">
                                                    <button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
                                                    </span>
                                                </div>
                                                <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
                                                    <input type="text" class="form-control form-filter input-sm" readonly name="time_call_to" placeholder="To">
                                                    <span class="input-group-btn">
                                                    <button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
                                                    </span>
                                                </div>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        $("#campaign_id").change(function(){
            location.href = HOT + "/client/import_phone?campaign_id=" + $(this).val();
        });
