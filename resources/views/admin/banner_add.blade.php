...
<div class="page-content" style="min-height:1269px">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ url('/cms/custommers/lists') }}">Custommer</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="#">Add Custommer</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Add Custommer
                    </div>
                </div>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div>
                                            <span class="btn default btn-file">
                                                <span class="fileinput-new">Chọn hình </span>
                                                <span class="fileinput-exists">Đổi hình </span>
                                                <input type="file" class="thumb" name="logo" required data-bv-notempty-message="The Thumbnail is required and cannot be empty"/>
                                            </span>
                                            <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput">Xóa hình </a>
                                        </div>
                                    </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="{{ url('cms/services/lists') }}" class="btn default">Hủy</a>
                                </div>
                            </div>
                        </div>
                    </form>
