        ...
        <div class="col-md-12">
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{ url('cms/portfollio/add') }}" class="btn btn-circle btn-default">
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        <table class="table table-striped table-bordered table-hover" id="datatable_table_list" data-link_ajax="{{ url('/cms/portfollio/ajax') }}">
                        <thead>
                        ...
                        <tr role="row" class="filter">
                            <form action="" method="post">
                                ...
                                <td>
                                    <input type="text" class="form-control form-filter input-sm" name="logo">
                                </td>
                                <td>
