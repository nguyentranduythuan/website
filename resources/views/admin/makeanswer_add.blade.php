...
<div class="page-content" style="min-height:1269px">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ url('/cms/news/lists') }}">News</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="#">Add News</a>
                    ...
                    data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                        ...
                        <div class="form-body">
                            <div class="form-group" id="cate_id-error">
                                ...
                                <div class="col-md-3">
                                    <select class="form-control select2me" id="cate_id" name="question" data-placeholder="Select...">
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="{{ url('cms/answer/lists') }}" class="btn default">Hủy</a>
                                </div>
                            </div>
                        </div>
                    </form>
