...
<div class="page-content" style="min-height:1269px">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ url('/cms/services/lists') }}">Service</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                        ...
                        <div class="form-body">
                            <div class="form-group" id="cate_id-error">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if($cate->id == $content->servicecate_id)
                                    ...
                                    <div class="fileinput @if(!empty($content->image)) fileinput-exists @else fileinput-new @endif" data-provides="fileinput">
                                        ...
                                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 300px; max-height: 138px;">
                                            @if(!empty($content->image))
                                                <img src="{{ url('uploads/service/'.$content->image) }}" style="max-width: 300px; max-height: 138px;" />
                                            @endif
                                        </div>
                                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="ckeditor" cols="80" id="editor1" name="content" rows="40">{!! $content->detail !!}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
