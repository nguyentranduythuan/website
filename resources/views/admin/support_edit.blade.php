...
<div class="page-content" style="min-height:1269px">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ url('/cms/support/lists') }}">Staff</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                    ...
                    data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                        ...
                        <div class="form-body">
                                    ...
                                    <div class="fileinput @if(!empty($content->image)) fileinput-exists @else fileinput-new @endif" data-provides="fileinput">
                                        ...
                                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 300px; max-height: 138px;">
                                            @if(!empty($content->image))
                                                <img src="{{ url('uploads/support/'.$content->image) }}" style="max-width: 300px; max-height: 138px;" />
                                            @endif
                                        </div>
                                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="ckeditor" cols="80" id="" name="content">{!! $content->content !!}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="{{ url('cms/support/lists') }}" class="btn default">Hủy</a>
                                </div>
                            </div>
                        </div>
                    </form>
