        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Add staff
                    </div>
                </div>
                    ...
                    data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="" rows="2" cols="80" id="" name="position" rows="40"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Profile Link <span class="required"> * </span></label>
                                <div class="col-md-9">
                                    <textarea class="" rows="2" cols="80" id="" name="link" rows="40"></textarea>
                                </div>
                            </div>
                            {{-- <div class="form-group">
