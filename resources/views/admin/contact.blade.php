            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-sharp bold uppercase">Contact</span>
                    </div>
                    <div class="actions">
                        <a href="{{ url('cms/contact/add') }}" class="btn btn-circle btn-default">
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        <table class="table table-striped table-bordered table-hover" id="datatable_table_list" data-link_ajax="{{ url('/cms/contact/ajax') }}">
                        <thead>
