...
<div class="page-content" style="min-height:1269px">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ url('/cms/service-bot/lists') }}">Benefit</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                    ...
                    data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Tittle <span class="required"> * </span></label>
                                <div class="col-md-6">
                                    <input required data-bv-notempty-message="The Name is required and cannot be empty" type="text" name="name" data-required="1" class="form-control" value="{{ $content->title }}" />
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="fileinput @if(!empty($content->image)) fileinput-exists @else fileinput-new @endif" data-provides="fileinput">
                                        ...
                                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 300px; max-height: 138px;">
                                            @if(!empty($content->image))
                                                <img src="{{ url('uploads/service_bot/'.$content->image) }}" style="max-width: 300px; max-height: 138px;" />
                                            @endif
                                        </div>
                                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="ckeditor" cols="80" id="aaa" name="content" rows="40">{{ $content->content }}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="{{ url('cms/service-top/lists') }}" class="btn default">Hủy</a>
                                </div>
                            </div>
                        </div>
                    </form>
