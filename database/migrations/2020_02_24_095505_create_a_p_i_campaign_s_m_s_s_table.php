...
class CreateAPICampaignSMSSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('a_p_i_campaign_s_m_s_s', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('a_p_i_campaign_s_m_s_s');
    }
}
