...
class CreateDataCampaignSMSSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('data_campaign_s_m_s_s', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('data_campaign_s_m_s_s');
    }
}
